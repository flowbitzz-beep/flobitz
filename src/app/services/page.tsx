...
import { Phone, Mail, Globe, Code, MessageCircle, PenTool, Video, Calculator, FileText, Database } from "lucide-react";
  ...
  return (
    <>
      ...
      <main className="flex flex-1 flex-col bg-[#FAF9F6]">
                  ...
                  <div className="mt-4 flex justify-center">
                    <span className="font-anton select-none text-[clamp(2rem,6vw,4.5rem)] leading-none tracking-[-0.02em] uppercase bg-clip-text text-transparent animate-smoke-text"
                          style={{ 
                            ...
                            WebkitTextStroke: '1px rgba(15, 23, 71, 0.05)'
                          }}>
                      SERVICES
                    </span>
                  </div>
        ...
        {/* --- SECTION 1: IT SERVICES (THE CIRCUIT WORLD) --- */}
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              <div className="w-full lg:w-1/2">
                <ScrollReveal>
                  ...
                  <h2 className="text-[clamp(2.5rem,8vw,4.5rem)] font-black uppercase tracking-tighter leading-[0.9] text-[#0f0e47]">
                    Digital Foundations
                  </h2>
                  <p className="mt-8 text-lg text-zinc-500 max-w-xl">
                    We build custom websites, software, and AI chatbots that help businesses work smarter, connect better, and grow faster.
                  </p>
                </ScrollReveal>
                ...
                <div className="mt-12 space-y-8">
                  <ScrollReveal delay={0.1}>
                    <div className="flex gap-6 group">
                      <div className="shrink-0 w-12 h-12 rounded-2xl bg-[#0f0e47] flex items-center justify-center text-white shadow-lg transition-transform group-hover:scale-110">
                  ...
                  <ScrollReveal delay={0.2}>
                    <div className="flex gap-6 group">
                      <div className="shrink-0 w-12 h-12 rounded-2xl bg-zinc-900 flex items-center justify-center text-white shadow-lg transition-transform group-hover:scale-110">
                  ...
                  <ScrollReveal delay={0.3}>
                    <div className="flex gap-6 group">
                      <div className="shrink-0 w-12 h-12 rounded-2xl bg-zinc-300 flex items-center justify-center text-[#0f0e47] shadow-lg transition-transform group-hover:scale-110">
                  ...
                  <div className="relative aspect-square rounded-[3rem] overflow-hidden border border-black/5 shadow-2xl bg-zinc-50">
                    ...
                    <div className="absolute bottom-10 right-10 flex gap-2 z-20">
                      {techImages.map((_, i) => (
                        <div 
                          key={i} 
                          className={`w-1.5 h-1.5 rounded-full transition-all duration-500 ${i === techIndex ? "bg-white w-4" : "bg-white/30"}`}
                        />
                      ))}
                    </div>

                    <div className="absolute bottom-10 left-10 p-6 bg-white/90 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl z-20">
                      <p className="text-4xl font-black text-[#0f0e47] leading-none">50+</p>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mt-2">Projects Delivered</p>
                    </div>
                  </div>
                </ScrollReveal>
              </div>
        ...
        {/* --- SECTION 2: GRAPHIC & VIDEO (THE ORGANIC WORLD) --- */}
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 relative z-10">
            <div className="flex flex-col-reverse lg:flex-row gap-16 items-center">
              <div className="w-full lg:w-1/2 relative flex justify-center">
                <ScrollReveal>
                  <div className="relative w-[min(85vw,480px)]">
                    <div className="relative aspect-square w-full animate-float">
                      <Image
                        src="/graphic-design-hero.png"
                        alt="Crystalline glass flower"
                        fill
                        className="object-contain object-center drop-shadow-[0_0_80px_rgba(255,255,255,0.2)]"
                      />
                    </div>
                    {/* Artistic glass overlay */}
              ...
              <div className="w-full lg:w-1/2">
                <ScrollReveal>
                  ...
                  <h2 className="text-[clamp(2.5rem,8vw,4.5rem)] font-black uppercase tracking-tighter leading-[0.9] text-white">
                    Visual Identity
                  </h2>
                  <p className="mt-8 text-lg text-zinc-300 max-w-xl">
                    Your brand deserves clean, impactful visuals that actually work. We create consistent assets that build trust and drive results.
                  </p>
                </ScrollReveal>
                ...
                <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 rounded-3xl bg-gradient-to-br from-[#E2E1DD] to-white text-[#0f0e47] flex flex-col justify-center">
                    <p className="text-3xl font-black leading-none italic">MOTION-LED</p>
                    <p className="text-[10px] font-bold uppercase tracking-widest mt-2">Storytelling Focused</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* --- SECTION 3: FINANCIAL SERVICES (THE PRECISION GRID) --- */}
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 relative z-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              <div className="w-full lg:w-1/3 pt-4">
                <ScrollReveal>
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0f0e47]/5 border border-[#0f0e47]/10 mb-6">
                    <span className="w-2 h-2 rounded-full bg-[#0f0e47]" />
                    <span className="text-[10px] font-bold uppercase tracking-widest text-[#0f0e47]">Financial</span>
                  </div>
                  <h2 className="text-[clamp(2.5rem,6vw,3.5rem)] font-black uppercase tracking-tighter leading-[0.9] text-[#0f0e47]">
                    Financial Precision
                  </h2>
                  <p className="mt-8 text-base text-zinc-500">
                    Simplifying your financial processes so you can focus on growth while we handle the numbers across Dubai and the UAE.
                  </p>
                </ScrollReveal>
                ...
                <div className="mt-12 p-8 rounded-[2rem] bg-zinc-950 text-white shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="mt-8 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#E2E1DD]">
                    <span className="w-2 h-2 rounded-full bg-[#E2E1DD]" />
                    UAE FTA GUIDELINES
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <ScrollReveal delay={0.2}>
                  <div className="glass-panel p-8 rounded-3xl border border-black/5 hover:border-[#0f0e47]/20 transition-all group">
                    ...
                    <ul className="mt-4 space-y-2 text-xs text-zinc-500">
                      <li>• Registration & Deregistration</li>
                      <li>• Calculation & Documentation</li>
                      <li>• Submission to FTA</li>
                    </ul>
                  </div>
                </ScrollReveal>
                <ScrollReveal delay={0.3}>
                  <div className="glass-panel p-8 rounded-3xl border border-black/5 hover:border-[#0f0e47]/20 transition-all group">
                    ...
                    <ul className="mt-4 space-y-2 text-xs text-zinc-500">
                      <li>• Invoice Entry & Management</li>
                      <li>• Custom Excel reports</li>
                      <li>• MIS reporting and analysis</li>
                    </ul>
                  </div>
                </ScrollReveal>
                <ScrollReveal delay={0.4}>
                  <div className="glass-panel p-8 rounded-3xl border border-black/5 hover:border-[#0f0e47]/20 transition-all group">
                    ...
                    <ul className="mt-4 space-y-2 text-xs text-zinc-500">
                      ...
                      <li>• Advisory for Optimization</li>
                    </ul>
                  </div>
                </ScrollReveal>
              </div>
        ...
        {/* --- GLOBAL CTA (WITH CURVE TRANSITION) --- */}
            ...
            <div className="mx-auto max-w-2xl px-5">
              <ScrollReveal>
                <h2 className="text-4xl sm:text-5xl font-black uppercase tracking-tighter text-white">
                  Ready to <span className="text-zinc-400">transform?</span>
                </h2>
                <p className="mt-6 text-zinc-400 mb-12 text-lg">
                  Whether it's code, creativity, or compliance, we bring precision to everything we build.
                </p>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-4 rounded-full bg-white px-12 py-5 text-sm font-black uppercase tracking-[0.2em] text-[#0f172a] shadow-2xl transition-all hover:bg-zinc-100 hover:scale-105 active:scale-95"
                >
