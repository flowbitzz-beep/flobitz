...
import { Mail, Rocket, Globe } from "lucide-react";
...
const steps = [
  { n: "01", title: "Understand", body: "We deeply learn your goals, challenges, and vision.", color: "#ec4899" }, // Pink
  { n: "02", title: "Plan",       body: "We design a clear strategy and roadmap tailored to you.", color: "#06b6d4" }, // Cyan
  { n: "03", title: "Execute",    body: "Our team builds, iterates, and refines with precision.", color: "#10b981" }, // Emerald
  { n: "04", title: "Deliver",    body: "You receive a polished result with ongoing support.", color: "#b642f8" },   // Purple
];
    ...
    <ScrollReveal delay={index * 0.1}>
      ...
      >
        ...
        >
          ...
          {/* Large Parallax Background Illustration */}
          <motion.div 
          ...
          <div className="relative z-10">
            ...
            <div className="mt-12">
              <p className="text-[11px] font-bold uppercase tracking-[0.25em]" style={{ color: service.theme.primary }}>
                {service.tag}
              </p>
              <h3 className="mt-3 font-sans font-bold text-[clamp(1.5rem,4vw,2rem)] uppercase tracking-tight leading-none transition-colors whitespace-nowrap" style={{ color: service.theme.primary }}>
                {service.title}
              </h3>
              <div className="mt-5 text-base leading-relaxed text-zinc-500 transition-colors group-hover:text-zinc-800">
                {service.description}
              </div>
            </div>

            <div className="mt-auto pt-10 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest opacity-0 transition-all duration-500 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0" style={{ color: service.theme.primary }}>
              Experience excellence <span aria-hidden>→</span>
            </div>
          </div>
        </Link>
      </motion.div>
...
function BentoCard({ 
  ...
  return (
    <ScrollReveal delay={delay} className={className}>
      ...
      >
        {/* Abstract Background Icon (Parallax) */}
        <motion.div
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.3em] text-[#0f0f45]/60 max-w-[200px]">
            {label}
          </p>
        </div>
      </div>
      ...
      <main className="flex flex-1 flex-col">
            ...
            <ScrollReveal>
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10">
                <div className="max-w-2xl">
                  <p className="text-sm font-semibold uppercase tracking-[0.35em] text-[#0f0f45]/60">
                    What we offer
                  </p>
                ...
                <div className="max-w-sm mb-2">
                  <p className="text-zinc-500 leading-relaxed text-sm lg:text-base">
                    From enterprise software to creative branding, we provide 
                    the architectural glue that holds your vision together.
                  </p>
                </div>
              </div>
            </ScrollReveal>
        ...
        <section className="relative bg-transparent py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none" 
               style={{ backgroundImage: 'radial-gradient(#0f0f45 0.5px, transparent 0.5px)', backgroundSize: '24px 24px' }} />
                ...
                <ScrollReveal>
                  ...
                  <div className="mt-10 space-y-8 max-w-md">
                    <p className="text-lg text-zinc-500 leading-relaxed">
                      Our methodology blends architectural precision with rapid visual innovation. 
                      Every project is a commitment to performance and brand longevity.
                    </p>
                    <div className="flex flex-wrap gap-4">
                      {["Agile", "Certified", "End-to-End"].map(tag => (
                        <span key={tag} className="inline-flex items-center rounded-full bg-zinc-100 px-4 py-1.5 text-xs font-semibold text-zinc-800 border border-black/5">
                          {tag}
                        </span>
                      ))}
                    </div>
        ...
        {/* ── Our Methodology (Compact Grid) ── */}
        <section id="methodology" className="bg-transparent py-16 lg:py-20">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <ScrollReveal>
              <div className="mb-12 text-center">
                <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#0f0f45]/60">The Journey</p>
                <h2 className="mt-4 font-sans font-bold text-[clamp(2rem,6vw,3.5rem)] uppercase tracking-tight leading-[0.9] text-black">
                  Our <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {steps.map((step, i) => (
                <ScrollReveal key={step.n} delay={0.1 * i}>
                  <div 
                    className="group relative flex h-full flex-col overflow-hidden rounded-[2.5rem] border border-black/5 bg-white p-8 transition-all duration-700 hover:shadow-2xl hover:shadow-[#0f0f45]/5"
                    style={{ 
                      "--theme-color": step.color,
                      "--theme-color-light": `${step.color}4D`, // 30% opacity
                      borderColor: `${step.color}15`
                    } as React.CSSProperties}
                  >
                    {/* Hover Border Overlay (Subtle Tint) */}
                    <div 
                      className="absolute inset-0 border-2 border-transparent transition-colors duration-700 group-hover:border-[var(--theme-color-light)] pointer-events-none rounded-[2.5rem]" 
                    />

                    <div className="relative z-10 flex items-center gap-5">
                      <span 
                        className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl font-sans font-black text-xl transition-all duration-500 group-hover:scale-110 shadow-sm"
                        style={{ 
                      ...
                      <h3 className="font-sans font-bold text-2xl uppercase tracking-tight text-[#0f0f45] transition-colors duration-500 group-hover:text-black">
                         {step.title}
                      </h3>
                    </div>

                    <div className="relative z-10">
                      <p className="mt-6 text-base leading-relaxed text-zinc-500 group-hover:text-zinc-800 transition-colors duration-500">
                        {step.body}
                      </p>
                    </div>

                    {/* Architectural Ornament (Dynamic Hover) */}
                    <div 
                      className="absolute -bottom-8 -right-8 h-32 w-32 opacity-[0.05] grayscale transition-all duration-700 group-hover:opacity-30 group-hover:grayscale-0 group-hover:scale-110"
                      style={{ color: "var(--theme-color)" }}
                    >
                      <div className="h-full w-full rounded-full border-[8px] border-dashed border-current" />
                    </div>
                  </div>
                </ScrollReveal>
              ))}
        ...
        {/* ── Core Excellence (Horizontal Marquee) ── */}
        <section className="bg-transparent py-48 border-t border-black/5 overflow-hidden">
          <div className="mx-auto max-w-7xl px-5 sm:px-8 mb-20 text-center">
            <ScrollReveal>
              <p className="text-xs font-bold uppercase tracking-[0.4em] text-[#0f0f45]/60">Expertise</p>
              <h2 className="mt-6 font-sans font-bold text-[clamp(2rem,6vw,4rem)] uppercase tracking-tight text-black">
                Core excellence
              </h2>
            </ScrollReveal>
          </div>
          ...
          <div className="relative flex whitespace-nowrap">
            ...
            >
              {[...whyChoose, ...whyChoose, ...whyChoose, ...whyChoose].map((item, i) => (
        ...
        {/* ── Unified Blue Bottom Section (With SVG Curve Transition) ── */}
        <section id="contact" className="relative mt-32">
          ...
          <div className="absolute top-0 left-0 w-full overflow-hidden leading-none -translate-y-[99%]">
            <svg 
              ...
              className="relative block w-[calc(100%+1.3px)] h-[80px] fill-[#0f172a]"
            >
              <path d="M0,0 C150,0 200,100 600,100 C1000,100 1050,0 1200,0 L1200,120 L0,120 Z" />
            </svg>
          </div>
            ...
            <div className="mx-auto max-w-7xl px-5 sm:px-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-12 pb-20 border-b border-white/5">
                <ScrollReveal className="flex-1 text-center md:text-left">
                  <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#b642f8]/80">
                    Next Step
                  </p>
                  <h2 className="mt-4 font-sans font-bold text-3xl sm:text-5xl uppercase tracking-tighter leading-tight text-white">
                    Bring your <span className="text-zinc-400">vision to life.</span>
                  </h2>
                </ScrollReveal>
                ...
                <div className="flex flex-wrap items-center justify-center gap-5">
                  <ScrollReveal delay={0.2}>
                    <motion.a 
                      ...
                      className="flex items-center gap-4 rounded-full bg-white px-10 py-5 text-[#0f172a] font-black transition-all shadow-2xl hover:shadow-[#b642f8]/30"
                    >
                      <Rocket className="h-5 w-5" />
                      <span className="text-xs uppercase tracking-[0.15em]">Start Project</span>
                    </motion.a>
                  </ScrollReveal>
                </div>
              </div>
