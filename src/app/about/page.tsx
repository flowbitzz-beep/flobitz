...
import { Rocket, Shield, Workflow, Target, Zap, Heart, Mail, Users, Star } from "lucide-react";
    ...
    <ScrollReveal delay={delay} className={className}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.3em] text-[#0f0f45]/60 max-w-[180px]">
            {label}
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <main className="flex flex-col flex-1">
        ...
        {/* ── Hero Section (Integrated Entrance) ── */}
          ...
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 relative z-10 pt-20">
            <ScrollReveal>
              ...
              <p className="mt-12 max-w-2xl text-base sm:text-lg text-zinc-500 leading-snug">
                Flobitz is a dynamic and forward-thinking company delivering high-quality
                IT, financial, and graphic design solutions to businesses of all sizes. With
                over 3+ years of industry experience, we have built a strong foundation 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <ScrollReveal>
                <div className="group h-full rounded-[2.5rem] border border-[#06b6d4]/10 bg-cyan-50/30 p-12 transition-all duration-700 hover:shadow-2xl hover:shadow-cyan-500/5">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-black/5 mb-8 transition-transform group-hover:scale-110">
                  ...
                  <p className="mt-8 text-lg text-zinc-600 leading-relaxed">
                    Our team consists of multi-talented professionals specializing in technology, 
                    finance, and creative design. We work collaboratively to provide smart, 
                    efficient, and customized solutions tailored to each client&apos;s needs.
                  </p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.1}>
                <div className="group h-full rounded-[2.5rem] border border-[#b642f8]/10 bg-purple-50/30 p-12 transition-all duration-700 hover:shadow-2xl hover:shadow-purple-500/5">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-black/5 mb-8 transition-transform group-hover:scale-110">
                    <Star className="h-6 w-6 text-[#b642f8]" />
                  </div>
                  <h2 className="text-3xl font-black uppercase tracking-tight text-[#0f0f45]">Our Belief</h2>
                  <p className="mt-8 text-lg text-zinc-600 leading-relaxed">
                    At Flobitz, we believe in delivering not just services, but value and results. 
                    Our commitment to quality, transparency, and client satisfaction makes us a 
                    trusted partner for businesses looking to grow and succeed.
                  </p>
                </div>
              </ScrollReveal>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
              <ScrollReveal>
                 ...
                 <h2 className="text-[clamp(2.5rem,6vw,4rem)] font-black uppercase tracking-tight leading-[0.9] text-[#0f0f45]">
                   Proven <br />
                   <span className="text-zinc-300">Success.</span>
                 </h2>
                 <p className="mt-8 text-lg text-zinc-500 leading-relaxed max-w-md">
                   Over the years, we have successfully completed 50+ projects for clients across 
                   various industries, helping them improve performance, strengthen their digital 
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                <ScrollReveal className="flex-1 text-center md:text-left">
                  ...
                  <h2 className="mt-4 font-sans font-bold text-3xl sm:text-5xl uppercase tracking-tighter leading-tight text-white">
                    Ready to build <br /><span className="text-zinc-400">your success?</span>
                  </h2>
                </ScrollReveal>
                ...
                <ScrollReveal delay={0.2}>
                  ...
                  >
                    ...
                    <span className="text-xs uppercase tracking-[0.15em]">Let's Connect</span>
                  </motion.a>
                </ScrollReveal>
              </div>
            </div>
