          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <ScrollReveal>
              ...
              <p className="mt-8 text-base sm:text-lg text-zinc-500 leading-snug max-w-md">
                Ready to grow your business? Let <span className="font-bold text-[#0f0e47]">Flobitz</span> help you achieve your goals with architectural precision and smart solutions.
              </p>
            </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div className="space-y-6 text-left">
                  <div className="flex items-center gap-4 group">
                    <div className="w-10 h-10 rounded-full bg-[#0f0e47]/5 flex items-center justify-center text-[#0f0e47] border border-[#0f0e47]/10 transition-colors group-hover:bg-[#0f0e47] group-hover:text-white"><Phone className="w-5 h-5" /></div>
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Call / WhatsApp</p>
                      <a href="https://wa.me/918796078717" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-[#0f0e47] hover:underline">+91 87960 78717</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <div className="w-10 h-10 rounded-full bg-[#0f0e47]/5 flex items-center justify-center text-[#0f0e47] border border-[#0f0e47]/10 transition-colors group-hover:bg-[#0f0e47] group-hover:text-white"><Mail className="w-5 h-5" /></div>
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Email Us</p>
                      <a href="mailto:flowbitzz@gmail.com" className="text-sm font-bold text-[#0f0e47] hover:underline">flowbitzz@gmail.com</a>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
